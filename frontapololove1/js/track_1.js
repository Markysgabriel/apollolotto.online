	...
	// Save sessid2 cookie
	document.cookie = "sessid2="+escape("sessid20260602150129463")+";expires="+spiexpire.toGMTString()+";path=/;domain=."+hostname;

	// Save funnel cookies
	document.cookie = "spi_funnel_codename="+escape("")+";expires="+spiexpire.toGMTString()+";path=/;domain=."+hostname;
				
						document.cookie = "sid="+escape("6a06f16d2b65644bb066e386")+";expires="+spiexpire.toGMTString()+";path=/;domain="+hostname;
						
	document.cookie = "referrer="+("2a00:b703:fff1:102::1::dailyhealthtipss.com%2F4p0l10%2F4rt3m1s%2Fl1%2Fmillionl0tto2026")+";expires="+spiexpire.toGMTString()+";path=/;domain="+hostname;
	...
	var spi_replace_str_bg = spi_pattern_base_bg+"sessid2="+escape("sessid20260602150129463")+"&";
	...
	var spi_replace_str_bg_html = spi_pattern_base_bg_html+"sessid2="+escape("sessid20260602150129463")+"&";
	...
	var spi_replace_str_bg_html2 = spi_pattern_base_bg_html2+"sessid2="+escape("sessid20260602150129463")+"&";
	...
	var spi_replace_str_bg_html3 = spi_pattern_base_bg_html3+"sessid2="+escape("sessid20260602150129463")+"&";
	...
	var spi_replace_str_bg_html4 = spi_pattern_base_bg_html4+"sessid2="+escape("sessid20260602150129463")+"&";

	var spi_pattern_enc_spi = "softwareprojects.com%2Fsecure%2F%3F";
	var spi_pattern_base_spi = "softwareprojects.com/secure/?";
	var spi_replace_str_spi = spi_pattern_base_spi+"sessid2="+escape("sessid20260602150129463")+"&";

	var spi_pattern_enc_cbd = "buygoodshomeoils.com%2Fsecure%2F%3F";
	var spi_pattern_base_cbd = "buygoodshomeoils.com/secure/?";
	var spi_replace_str_cbd = spi_pattern_base_cbd+"sessid2="+escape("sessid20260602150129463")+"&";
	...
	var spi_replace_str_cbd_html = spi_pattern_base_cbd_html+"sessid2="+escape("sessid20260602150129463")+"&";
				

spi_replace_str_cbd = spi_replace_str_cbd+'sid=6a06f16d2b65644bb066e386&';spi_replace_str_cbd_html = spi_replace_str_cbd_html+'sid=6a06f16d2b65644bb066e386&';spi_replace_str_bg = spi_replace_str_bg+'sid=6a06f16d2b65644bb066e386&';spi_replace_str_spi = spi_replace_str_spi+'sid=6a06f16d2b65644bb066e386&';spi_replace_str_bg_html = spi_replace_str_bg_html+'sid=6a06f16d2b65644bb066e386&';spi_replace_str_bg_html2 = spi_replace_str_bg_html2+'sid=6a06f16d2b65644bb066e386&';spi_replace_str_bg_html3 = spi_replace_str_bg_html3+'sid=6a06f16d2b65644bb066e386&';spi_replace_str_bg_html4 = spi_replace_str_bg_html4+'sid=6a06f16d2b65644bb066e386&';
